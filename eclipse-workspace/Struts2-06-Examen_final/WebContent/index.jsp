	...
	<body>
		...
		<div id="solucion">
			<div>
				...
				<s:form action="altaviaje_costeviaje">
					<s:textfield name="viaje.noches" label="Indique el numero de noches" />
					<s:select list="#{'oviedo':'oviedo', 'tokyo':'tokyo','madrid':'madrid','barcelona':'barcelona'}" name="viaje.destino" label="Indique el destino"/>
					
					<s:submit />
				</s:form>
				<h2>Solucion</h2>
				<form>
					Coste del hotel: <input type="text" value="<s:property value="costeViaje.costeHotel" />">
					<br>
					Coste del avion: <input type="text" value="<s:property value="costeViaje.costeAvion" />">
					<br>
					Coste del alquiler del coche: <input type="text" value="<s:property value="costeViaje.costeAlquilerCoche" />">
					<br>
					<br>
					<span>Coste TOTAL: <input type="text" value="<s:property value="costeViaje.costeTotal" />"></span>
				</form>
			</div>
			<div>
				<h2>CONSULTA</h2>
