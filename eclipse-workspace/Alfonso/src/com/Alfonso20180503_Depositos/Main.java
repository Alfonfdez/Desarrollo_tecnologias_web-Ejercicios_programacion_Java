...
public class Main {
	...
	public static void main(String[] args) {
		...
		List <Deposito> depositos = new ArrayList<Deposito>(); //Haremos "cntrl + shift + O" y añadiremos interfaz
		depositos.add(d1);
		depositos.add(d2);
		depositos.add(d3);
		depositos.add(d4);
		...
		Iterator<Deposito> it = depositos.iterator(); //Haremos "cntrl + shift + O" y añadiremos interfaz
		while(it.hasNext()) {
			Deposito d = it.next();
