...
<html>
	...
	<body>
		...
		<s:form action="alta">	
			...
			<s:select list="#{'Pequena':'Pequena', 'Mediana':'Mediana','Grande':'Grande'}" name="pedido.size" label="Tamaño"/>
			<s:textfield name="pedido.codigo" label="Código promocional" />
			<s:select list="#{'Si':'Si', 'No':'No'}" name="pedido.entrega" label="Entrega"/> 	
			<s:submit />
		</s:form>
		<br>
		El precio es: <input type="text" value="<s:property value="costePedido.costeTotal" />">
		<br>
